<script>
	import BulletedList from '$lib/blog-components/elements/bulleted-list.svelte';
	import GridImage from '$lib/blog-components/elements/grid-image.svelte';
	import MainHeader from '$lib/blog-components/elements/main-header.svelte';
	...
	import Subtitle from '$lib/blog-components/elements/subtitle.svelte';
...
<div class="flex flex-col mx-auto lg:w-[60%] lg:px-0 p-8 lg:py-20">
	...
	<Paragraph>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
		labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
		<GridImage src="$lib/assets/images/etl-system-design.png" caption="System Design"></GridImage>
	...
	<BulletedList>
		...
		<li>
			...
			alias consequatur aut perferendis doloribus asperiores repella
		</li>
		<BulletedList>
			<li>
				At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
