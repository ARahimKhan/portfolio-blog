<script lang="ts">
	...
	const content = [
		...
		},
		{
			...
			title: 'Database relation viewer',
			slug: 'db-relations-viewer'
		},
		{
			description:
		...
		{
			description:
				"Classic hissssssssssssssssstoric snek game. Go around and try to eat everything. Don't bite your own tail",
			title: 'Snake',
			slug: 'snake'
		}
	];
